...
chromedriver = r"C:\Users\fudal\Pobrane\chromedriver"
...
class ComparisonWindow(Screen, FloatLayout,GridLayout):
    def __init__(self, **kwargs):
        super(ComparisonWindow, self).__init__(**kwargs)

        self.lbl = Label(text="Wprowadz fraze, ktora chcesz wyszukac:", font_size=20,
        ...
        self.txt = TextInput(font_size=20, size_hint_y=None, height=80, width=100,
    ...
    def pressed(self, instance):
        ...
        driver.find_element_by_xpath("/html/body/main/div[1]/header[1]/div/div/div[3]/form/div/input").send_keys(
            Keys.ENTER)
        for i in range(1, 6):
            cena = driver.find_element_by_xpath("/html/body/main/div[2]/div[1]/section/div[1]/article[" + (str)(
                i) + "]/div/div[3]/span/span[1]/span").text
            nazwa = driver.find_element_by_xpath(
                "/html/body/main/div[2]/div[1]/section/div/article[" + (str)(i) + "]/div/div[3]/strong/a").text
            link = driver.find_element_by_xpath("/html/body/main/div[2]/div[1]/section/div/article[" + (str)(
                i) + "]/div/div[3]/strong/a").get_attribute("href")
